...
import { detectTargetType, getReader, getWriter, getMixer, } from '../adapters/index.js';
import { retrieveValue, storeValue, clearKeys, } from '../services/valuecache.js';
import { getEase } from '../eases/eases.js';
 ...
 */
export function renderTween(config, operations) {
        ...
        for (const propName in keyframes) {
            ...
            for (let index = 0; index < total; index++) {
                ...
                if (playState !== IDLE) {
                    ...
                    const lowerIndex = upperIndex !== maybeUpperIndex ? upperIndex : upperIndex - 1;
                    ...
                    const offset = upperEase(getOffset(lowerTime, upperTime, localTime, index, total, upperProp.$stagger || 0, upperProp.$delay || 0, upperProp.$endDelay || 0));
...
//# sourceMappingURL=renderTween.js.map